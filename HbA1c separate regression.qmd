...
```{r}
ggplot(diabetes_df) + geom_point(aes(y=HbA1c, x=AGE))
```

```{r}
ggplot(diabetes_df) + geom_density_2d_filled(aes(y=HbA1c, x=AGE))
```

```{r}
ggplot(diabetes_df) +
    geom_density_2d_filled(aes(y=HbA1c, x=AGE)) +
    geom_line(aes(x=AGE, y=reg_1$fitted.values), color="red", linewidth=2)
```
...
```{r}
ggplot(diabetes_df) + geom_point(aes(y=HbA1c, x=BMI))
```

```{r}
ggplot(diabetes_df) + geom_density_2d_filled(aes(y=HbA1c, x=BMI))
```

```{r}
ggplot(diabetes_df) +
    geom_density_2d_filled(aes(y=HbA1c, x=BMI)) +
    geom_line(aes(x=BMI, y=reg_9$fitted.values), color="red", linewidth=2)
```
...
```{r}
ggplot(diabetes_df) + geom_point(aes(y=HbA1c, x=Gender_Dummy))
```

```{r}
ggplot(diabetes_df) + geom_density_2d_filled(aes(y=HbA1c, x=Gender_Dummy))
```

```{r}
ggplot(diabetes_df) +
    geom_density_2d_filled(aes(y=HbA1c, x=Gender_Dummy)) +
    geom_line(aes(x=Gender_Dummy, y=reg_10$fitted.values), color="red", linewidth=2)
```
